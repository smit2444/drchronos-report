...
const scope = 'labs:read messages:read patients:read patients:summary:read settings:read tasks:read user:read billing:patient-payment:read billing:read calendar:read clinical:read calendar:write clinical:write billing:write'; // Adjust the scope based on your needs
